...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_tree_root = 16,                 /* tree_root  */
  YYSYMBOL_exp = 17,                       /* exp  */
...
static const char *const yytname[] =
{
  ...
  "MUL", "DIV", "EQ", "EXP", "LP", "RP", "ABS", "ID", "EOL", "$accept",
  "tree_root", "exp", "factor", "term", YY_NULLPTR
};
